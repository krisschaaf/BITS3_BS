 ...
 */
typedef struct vmem_struct {
	struct pt_entry pt[VMEM_NPAGES];               //128!< page table Index: virtuelle Seitennummer
	int mainMemory[VMEM_NFRAMES * VMEM_PAGESIZE];  //128 !< main memory used by virtual memory simulation 
} vmem_struct;
